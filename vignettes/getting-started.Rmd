...
Development of this software was inspired by the `geneagrapher` Python package (<https://github.com/davidalber/geneagrapher>), and makes use of the WebSocket server run by `https://github.com/davidalber/geneagrapher-core` (<https://github.com/davidalber/geneagrapher-core>).
Permission to query this endpoint was requested and granted in advance (<https://github.com/davidalber/geneagrapher/issues/38>).
